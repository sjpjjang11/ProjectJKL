...
/*
    [RequireComponent(typeof(csLightsaberTrail))]
    public class csLightsaberTrailController : MonoBehaviour
    {

        csLightsaberTrail lightsaberTrail;

        void Start()
        {
            lightsaberTrail = GetComponent<csLightsaberTrail>();
        }
...
public class csLightsaberTrail : MonoBehaviour {
